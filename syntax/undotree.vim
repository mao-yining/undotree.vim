...
execute $"syn match UndotreeNode ' \\zs{g:undotree_TreeNodeShape->escape('*')}\\ze '"
execute $"syn match UndotreeNodeCurrent '\\zs{g:undotree_TreeNodeShape->escape('*')}\\ze.*>\d\+<'"
syn match UndotreeTimeStamp '(.*)$'
syn match UndotreeFirstNode 'Original'
execute $"syn match UndotreeBranch '[{g:undotree_TreeVertShape .. g:undotree_TreeSplitShape .. g:undotree_TreeReturnShape->escape('\')}]'"
